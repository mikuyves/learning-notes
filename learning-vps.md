...
根据上图提示，依次输入自己想设置的端口和密码，回车键用于确认
...
来自- Alvin9999 自己搭建ss/ssr服务器教程（适合初学者） <https://github.com/XX-net/XX-Net/issues/6506>
